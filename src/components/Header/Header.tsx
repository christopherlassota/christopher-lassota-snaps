...
const Header = ({filterClick, buttonState}: HeaderProps) => {

  return (
    <header className="header">
      <section className="header__container">
        <h1 className="header__title">Snaps</h1>
        <div onClick={filterClick} className={`header__button header__button${buttonState}`}>
          <p className={`header__filters header__filters${buttonState}`}>Filters</p>
          <svg
          ...
          >
            <path
              className={`header__path header__path${buttonState}`}
